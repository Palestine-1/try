    ...
    <section class="py-5 text-center">
        <div class="container">
            ...
            <div class="row mt-4 g-4 justify-content-center">
                <div class="col-md-4">
                    <a href="<?php echo e(route('formcert')); ?>" class="text-decoration-none">
                ...
                <div class="col-md-4">
                    <a href="<?php echo e(route('formid')); ?>" class="text-decoration-none">
                        <div class="card p-3 shadow-sm hover-card h-100">
                            <h5 class="text-primary">وزارة الداخلية</h5>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\network\resources\views/welcome.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <header class="text-center py-5" style="background-image: url('<?php echo e(asset('storage/images/Egyptian_Police_Emblem.svg')); ?>'); background-size: cover; background-position: center; min-height: 600px; position: relative; width: 100vw; margin-left: calc(-50vw + 50%); margin-right: calc(-50vw + 50%);">
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-sm border-primary h-100">
                    <div class="card-body py-5">
                        ...
                        <a href="<?php echo e(route('formcert')); ?>" class="btn btn-outline-primary px-4">تقديم الطلب</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center shadow-sm border-primary h-100">
                    <div class="card-body py-5">
                        ...
                        <a href="<?php echo e(route('formid')); ?>" class="btn btn-outline-primary px-4">تقديم الطلب</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\network\resources\views/main/cert.blade.php ENDPATH**/ ?>
...
<div class="container my-5" id="certificate-content">
    <div class="card birth-certificate p-4 shadow">
        ...
        <div class="body">
            <p><strong>تشهد وزارة الصحة بأن السيدة/السيد</strong> <?php echo e($birthCertificate->name); ?></p>
            ...
            <p><strong>محل الميلاد:</strong> <?php echo e($birthCertificate->address); ?></p>
        </div>

            <div class="footer">
                <div class="issue-date text-left">
                    <strong>تاريخ الإصدار:</strong> <?php echo e(now()->format('Y-m-d')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\network\resources\views/main/resuly.blade.php ENDPATH**/ ?>